...
const copy = {
  zh: {
    eyebrow: 'Shelby Builder Demo',
    title: '开发者测试网演示控制台',
    subtitle: '给 Shelby 团队和社区成员看的开发者展示入口：确认部署模式、准备钱包和测试资产、上传证据包，并检查 Shelby testnet 证明。',
    body:
      '这里展示一条可跑通的构建路径：钱包签名、Shelby Blob 注册、Neon/SQLite 证据索引，以及面向检索的回执验证。',
    start: '开始上传',
    ...
    walletBody:
      '试跑演示前先在这里检查钱包扩展、连接状态和 Aptos Testnet 网络。真实上传仍在 /upload 完成。',
    walletBlocked:
      '当前部署仍是 Mock 预览；可以检查钱包，但 Shelby testnet 实传需要 SHELBY_MODE=testnet。',
    ...
    enabled: 'Testnet 已启用',
    enabledBody: '当前部署已开启 Shelby 测试网演示路径。',
    mock: 'Mock 预览',
    mockBody: '当前部署仍是本地预览；试跑 Shelby testnet 需开启 testnet。',
    steps: [
    ...
    acceptanceTitle: '演示验收',
    sessionTitle: 'Builder demo 会话',
    sessionBody:
      '完成真实测试网上传后，这里会从浏览器缓存和 Neon/Postgres 或 SQLite 账本聚合最近的 shelby-testnet 回执、引用 Blob 与可提交的演示摘要。',
    sessionEmptyTitle: '尚未形成测试网会话',
    sessionEmptyBody:
      '当前浏览器还没有 shelby-testnet 回执。先连接钱包并完成一次测试网上传，再回到这里检查演示会话。',
    latestReceipt: '最近回执',
    linkedBlobs: '引用 Blob',
    noReceipt: '无测试网回执',
    openReceipt: '打开回执',
    ...
    sourceBrowser: '浏览器缓存',
    sourceSqlite: '持久化账本',
    sourceMixed: '浏览器缓存 + 持久化账本',
    acceptance: [
      '自动门禁：lint、build、release-candidate verifier 必须全绿。',
      '真实演示：连接 Aptos Testnet 钱包，完成一次小文件上传。',
    ...
    boundaryTitle: '演示边界',
    boundaries: [
      '开发者 Builder Demo，不声称官方产品、mainnet 或生产存储。',
  ...
  en: {
    eyebrow: 'Shelby Builder Demo',
    title: 'Developer testnet demo console',
    subtitle:
      'A developer showcase for the Shelby team and community: confirm runtime mode, prepare wallet and test assets, upload evidence, then inspect Shelby testnet proof through Blob details and read receipts.',
    body:
      'This page shows a runnable builder path: wallet signing, Shelby Blob registration, Neon/SQLite evidence indexing, and retrieval-oriented receipt verification.',
    start: 'Start upload',
    docs: 'Shelby React SDK',
    ...
    walletBody:
      'Before trying the demo, check wallet extension detection, connection state, and Aptos Testnet alignment here. Real upload still happens on /upload.',
    walletBlocked:
      'This deployment is still in Mock preview. Wallet readiness can be checked, but real Shelby testnet upload requires SHELBY_MODE=testnet.',
    ...
    enabledBody: 'This deployment has enabled the Shelby testnet demo path.',
    mock: 'Mock preview',
    mockBody: 'This deployment is still a local preview; trying Shelby testnet requires testnet mode.',
    steps: [
    ...
    acceptanceTitle: 'Demo acceptance',
    sessionTitle: 'Builder demo session',
    sessionBody:
      'After a real testnet upload, this panel aggregates the latest shelby-testnet receipt, referenced Blobs, and a shareable demo summary from browser cache plus the Neon/Postgres or SQLite ledger.',
    sessionEmptyTitle: 'No testnet session yet',
    sessionEmptyBody:
      'This browser has no shelby-testnet receipt yet. Connect a wallet, complete one testnet upload, then return here to inspect the demo session.',
    ...
    sourceSqlite: 'persistent ledger',
    sourceMixed: 'browser cache + persistent ledger',
    acceptance: [
      'Automated gate: lint, build, and release-candidate verifier must stay green.',
      'Live demo: connect an Aptos Testnet wallet and upload one small file.',
    ...
    boundaryTitle: 'Demo boundary',
    boundaries: [
      'Developer builder demo only; no official-product, mainnet, or production storage claim.',
