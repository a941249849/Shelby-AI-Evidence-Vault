...
This is the one-command release-candidate gate (C12/X15). It runs the complete product loop end to end, including all of the above plus the public testnet handoff JSON contract, a production build, and route smoke checks against a live server instance. It is zero-credential and mock-safe by default.
